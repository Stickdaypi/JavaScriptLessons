// Это дополнительная сложная задачка, в которой вы можете попробовать свои силы. Такого типа задачи часто дают на собеседованиях.

// Решать её не обязательно, но можно посмотреть ответ и разобраться в нем. Чтобы платформа засчитала задание пройденным, можно скопировать его из ответов.
